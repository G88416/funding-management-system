...
Finance and opportunity search engine that matches financing needs with investors and grant sources across South Africa, Russia, China, Brazil, and India.
...
- Firestore rules allow public reads for funders and contract leads but require authenticated users with the `admin` custom claim for writes and analytics collections.
